...
export default new Vuex.Store({
  ...
  mutations: {
    ...
    set_status_seller(state, payload) {
      let object = { status_seller: payload};
      
      state.user = Object.assign({}, state.user, object);
  ...
  getters: {
    ...
    isStatusSellerSent(state,getters){
      return state.user.status_seller
    }
  },
  modules: {},
});
